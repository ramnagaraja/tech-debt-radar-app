...
function quantileIndex(values, p, valueof = number$2) {
	if (isNaN(p = +p)) return;
	numbers = Float64Array.from(values, (_, i) => number$2(valueof(values[i], i, values)));
...
//#endregion
export { halfPi as $, FormatSpecifier as $n, descending as $r, utcFridays as $t, diamond2_default as A, timeInterval as An, range as Ar, timeYear as At, line_default as B, linear as Bn, tickIncrement as Br, timeMonday as Bt, wye_default as C, timeMinutes as Cn, color as Cr, utcFormat as Ct, square2_default as D, seconds as Dn, rgbConvert as Dr, timeTicks as Dt, star_default as E, second as En, rgb as Er, timeTickInterval as Et, bumpRadial as F, pow as Fn, quickselect as Fr, timeMonths as Ft, slice as G, ordinal as Gn, sort as Gr, timeSundays as Gt, y as H, band as Hn, ticks as Hr, timeSaturday as Ht, bumpX as I, sqrt$1 as In, minIndex as Ir, utcMonth as It, acos as J, precisionFixed_default as Jn, InternSet as Jr, timeTuesday as Jt, withPath as K, precisionRound_default as Kn, permute as Kr, timeThursday as Kt, bumpY as L, symlog as Ln, min$1 as Lr, utcMonths as Lt, cross_default as M, quantize as Mn, quantileIndex as Mr, utcYear as Mt, circle_default as N, quantile as Nn, quantileSorted as Nr, utcYears as Nt, square_default as O, millisecond as On, define_default as Or, utcTickInterval as Ot, asterisk_default as P, radial as Pn, greatest as Pr, timeMonth as Pt, epsilon as Q, locale_default as Qn, bisector as Qr, utcFriday as Qt, pointRadial_default as R, log as Rn, maxIndex as Rr, timeFriday as Rt, times_default as S, timeMinute as Sn, brighter as Sr, timeParse as St, triangle_default as T, utcMinutes as Tn, hsl as Tr, formatLocale as Tt, linear_default as U, point$2 as Un, ascendingDefined as Ur, timeSaturdays as Ut, x as V, tickFormat as Vn, tickStep as Vr, timeMondays as Vt, array_default as W, implicit as Wn, compareDefined as Wr, timeSunday as Wt, atan2 as X, format as Xn, bisectLeft as Xr, timeWednesday as Xt, asin as Y, defaultLocale$1 as Yn, bisectCenter as Yr, timeTuesdays as Yt, cos as Z, formatPrefix as Zn, bisectRight as Zr, timeWednesdays as Zt, basis_default as _, utcDays as _n, nogamma as _r, sequentialSymlog as _t, none_default as a, utcSundays as an, round_default as ar, tau as at, symbolsFill as b, utcHour as bn, Color as br, defaultLocale as bt, stepBefore as c, utcTuesday as cn, object_default as cr, divergingLog as ct, monotoneX as d, utcWednesdays as dn, array_default$1 as dr, divergingSymlog as dt, ascending as ei, utcMonday as en, formatSpecifier as er, max as et, monotoneY as f, timeDay as fn, numberArray_default as fr, sequentialQuantile as ft, Basis as g, utcDay as gn, hue as gr, sequentialSqrt as gt, basisClosed_default as h, unixDays as hn, rgb_default as hr, sequentialPow as ht, stack_default as i, utcSunday as in, piecewise as ir, sqrt as it, diamond_default as j, threshold as jn, quantile$1 as jr, timeYears as jt, plus_default as k, milliseconds as kn, extend as kr, utcTicks as kt, step_default as l, utcTuesdays as ln, number_default as lr, divergingPow as lt, basisOpen_default as m, unixDay as mn, rgbBasisClosed as mr, sequentialLog as mt, silhouette_default as n, utcSaturday as nn, path as nr, pi as nt, none_default$1 as o, utcThursday as on, value_default as or, constant_default as ot, linearClosed_default as p, timeDays as pn, rgbBasis as pr, sequential as pt, abs as q, precisionPrefix_default as qn, InternMap as qr, timeThursdays as qt, expand_default as r, utcSaturdays as rn, pathRound as rr, sin as rt, stepAfter as s, utcThursdays as sn, string_default as sr, diverging as st, wiggle_default as t, utcMondays as tn, Path as tr, min as tt, natural_default as u, utcWednesday as un, date_default as ur, divergingSqrt as ut, noop_default as v, timeHour as vn, basisClosed_default$1 as vr, utcTime as vt, triangle2_default as w, utcMinute as wn, darker as wr, utcParse as wt, symbolsStroke as x, utcHours as xn, Rgb as xr, timeFormat as xt, Symbol$1 as y, timeHours as yn, basis_default$1 as yr, time as yt, area_default as z, identity as zn, max$1 as zr, timeFridays as zt };
