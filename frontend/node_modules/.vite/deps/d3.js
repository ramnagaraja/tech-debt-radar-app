import { $ as halfPi$3, $n as FormatSpecifier, $r as descending, $t as utcFridays, A as diamond2_default, An as timeInterval, Ar as range, At as timeYear, B as line_default, Bn as linear$1, Br as tickIncrement, Bt as timeMonday, C as wye_default, Cn as timeMinutes, Cr as color, Ct as utcFormat, D as square2_default, Dn as seconds, Dr as rgbConvert, Dt as timeTicks, E as star_default, En as second, Er as rgb, Et as timeTickInterval, F as bumpRadial, Fn as pow, Fr as quickselect, Ft as timeMonths, G as slice$3, Gn as ordinal, Gr as sort, Gt as timeSundays, H as y$2, Hn as band, Hr as ticks, Ht as timeSaturday, I as bumpX, In as sqrt, Ir as minIndex, It as utcMonth, J as acos$1, Jn as precisionFixed_default, Jr as InternSet, Jt as timeTuesday, K as withPath, Kn as precisionRound_default, Kr as permute, Kt as timeThursday, L as bumpY, Ln as symlog, Lr as min, Lt as utcMonths, M as cross_default, Mn as quantize, Mr as quantileIndex, Mt as utcYear, N as circle_default$2, Nn as quantile$1, Nr as quantileSorted, Nt as utcYears, O as square_default, On as millisecond, Or as define_default, Ot as utcTickInterval, P as asterisk_default, Pn as radial, Pr as greatest, Pt as timeMonth, Qn as locale_default, Qr as bisector, Qt as utcFriday, R as pointRadial_default, Rn as log, Rr as maxIndex, Rt as timeFriday, S as times_default, Sn as timeMinute, Sr as brighter, St as timeParse, T as triangle_default, Tn as utcMinutes, Tr as hsl, Tt as formatLocale, U as linear_default, Un as point, Ur as ascendingDefined, Ut as timeSaturdays, V as x$2, Vn as tickFormat, Vr as tickStep, Vt as timeMondays, W as array_default$2, Wn as implicit, Wr as compareDefined, Wt as timeSunday, X as atan2$1, Xn as format, Xr as bisectLeft, Xt as timeWednesday, Y as asin$1, Yn as defaultLocale, Yr as bisectCenter, Yt as timeTuesdays, Z as cos$2, Zn as formatPrefix, Zr as bisectRight, Zt as timeWednesdays, _ as basis_default, _n as utcDays, _r as nogamma, _t as sequentialSymlog, a as none_default$1, an as utcSundays, ar as round_default, at as tau$4, b as symbolsFill, bn as utcHour, br as Color, bt as defaultLocale$1, c as stepBefore, cn as utcTuesday, cr as object_default, ct as divergingLog, d as monotoneX, dn as utcWednesdays, dr as array_default, dt as divergingSymlog, ei as ascending, en as utcMonday, er as formatSpecifier, et as max$3, f as monotoneY, fn as timeDay, fr as numberArray_default, ft as sequentialQuantile, g as Basis, gn as utcDay, gr as hue, gt as sequentialSqrt, h as basisClosed_default, hn as unixDays, hr as rgb_default, ht as sequentialPow, i as stack_default, in as utcSunday, ir as piecewise, it as sqrt$2, j as diamond_default, jn as threshold, jr as quantile, jt as timeYears, k as plus_default, kn as milliseconds, kr as extend, kt as utcTicks, l as step_default, ln as utcTuesdays, lr as number_default, lt as divergingPow, m as basisOpen_default, mn as unixDay, mr as rgbBasisClosed, mt as sequentialLog, n as silhouette_default, nn as utcSaturday, nr as path, nt as pi$3, o as none_default, on as utcThursday, or as value_default, ot as constant_default$9, p as linearClosed_default, pn as timeDays, pr as rgbBasis, pt as sequential, q as abs$3, qn as precisionPrefix_default, qr as InternMap, qt as timeThursdays, r as expand_default, rn as utcSaturdays, rr as pathRound, rt as sin$2, s as stepAfter, sn as utcThursdays, sr as string_default, st as diverging, t as wiggle_default, tn as utcMondays, tr as Path, tt as min$2, u as natural_default, un as utcWednesday, ur as date_default, ut as divergingSqrt, v as noop_default$1, vn as timeHour, vr as basisClosed_default$1, vt as utcTime, w as triangle2_default, wn as utcMinute, wr as darker, wt as utcParse, x as symbolsStroke, xn as utcHours, xr as Rgb, xt as timeFormat, y as Symbol$1, yn as timeHours, yr as basis_default$1, yt as time, z as area_default, zn as identity, zr as max, zt as timeFridays } from "./wiggle-DrP4N6xb.js";
...
function axis(orient, scale) {
	...
	function axis(context) {
		var values = tickValues == null ? scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain() : tickValues, format = tickFormat == null ? scale.tickFormat ? scale.tickFormat.apply(scale, tickArguments) : identity_default$3 : tickFormat, spacing = Math.max(tickSizeInner, 0) + tickPadding, range = scale.range(), range0 = +range[0] + offset, range1 = +range[range.length - 1] + offset, position = (scale.bandwidth ? center : number)(scale.copy(), offset), selection = context.selection ? context.selection() : context, path = selection.selectAll(".domain").data([null]), tick = selection.selectAll(".tick").data(values, scale).order(), tickExit = tick.exit(), tickEnter = tick.enter().append("g").attr("class", "tick"), line = tick.select("line"), text = tick.select("text");
...
function data_default$1(value, key) {
	...
	if (typeof value !== "function") value = constant_default$8(value);
...
function drag_default() {
	...
	drag.filter = function(_) {
		return arguments.length ? (filter = typeof _ === "function" ? _ : constant_default$7(!!_), drag) : filter;
	};
	drag.container = function(_) {
		return arguments.length ? (container = typeof _ === "function" ? _ : constant_default$7(_), drag) : container;
	};
	drag.subject = function(_) {
		return arguments.length ? (subject = typeof _ === "function" ? _ : constant_default$7(_), drag) : subject;
	};
	drag.touchable = function(_) {
		return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default$7(!!_), drag) : touchable;
	};
	drag.on = function() {
...
var { abs: abs$2, max: max$2, min: min$1 } = Math;
function number1(e) {
	return [+e[0], +e[1]];
}
function number2(e) {
...
function brush(dim) {
	...
	function started(event) {
		...
		function moved(event) {
			...
			if (shifting && !lockX && !lockY && points.length === 1) {
				...
				if (abs$2(point.cur[0] - point[0]) > abs$2(point.cur[1] - point[1])) lockY = true;
				else lockX = true;
			}
	...
	brush.extent = function(_) {
		return arguments.length ? (extent = typeof _ === "function" ? _ : constant_default$6(number2(_)), brush) : extent;
	};
	brush.filter = function(_) {
		return arguments.length ? (filter = typeof _ === "function" ? _ : constant_default$6(!!_), brush) : filter;
	};
	brush.touchable = function(_) {
		return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default$6(!!_), brush) : touchable;
	};
...
function chord(directed, transpose) {
	...
	function chord(matrix) {
		var n = matrix.length, groupSums = new Array(n), groupIndex = range$2(0, n), chords = new Array(n * n), groups = new Array(n), k = 0, dx;
...
function ribbon(headRadius) {
	...
	function ribbon() {
		var buffer, s = source.apply(this, arguments), t = target.apply(this, arguments), ap = padAngle.apply(this, arguments) / 2, argv = slice$1.call(arguments), sr = +sourceRadius.apply(this, (argv[0] = s, argv)), sa0 = startAngle.apply(this, argv) - halfPi$1, sa1 = endAngle.apply(this, argv) - halfPi$1, tr = +targetRadius.apply(this, (argv[0] = t, argv)), ta0 = startAngle.apply(this, argv) - halfPi$1, ta1 = endAngle.apply(this, argv) - halfPi$1;
		if (!context) context = buffer = path();
		if (ap > 1e-12) {
			if (abs$1(sa1 - sa0) > ap * 2 + 1e-12) sa1 > sa0 ? (sa0 += ap, sa1 -= ap) : (sa0 -= ap, sa1 += ap);
			else sa0 = sa1 = (sa0 + sa1) / 2;
			if (abs$1(ta1 - ta0) > ap * 2 + 1e-12) ta1 > ta0 ? (ta0 += ap, ta1 -= ap) : (ta0 -= ap, ta1 += ap);
	...
	if (headRadius) ribbon.headRadius = function(_) {
		return arguments.length ? (headRadius = typeof _ === "function" ? _ : constant_default$5(+_), ribbon) : headRadius;
	};
	ribbon.radius = function(_) {
		return arguments.length ? (sourceRadius = targetRadius = typeof _ === "function" ? _ : constant_default$5(+_), ribbon) : sourceRadius;
	};
	ribbon.sourceRadius = function(_) {
		return arguments.length ? (sourceRadius = typeof _ === "function" ? _ : constant_default$5(+_), ribbon) : sourceRadius;
	};
	ribbon.targetRadius = function(_) {
		return arguments.length ? (targetRadius = typeof _ === "function" ? _ : constant_default$5(+_), ribbon) : targetRadius;
	};
	ribbon.startAngle = function(_) {
		return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default$5(+_), ribbon) : startAngle;
	};
	ribbon.endAngle = function(_) {
		return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default$5(+_), ribbon) : endAngle;
	};
	ribbon.padAngle = function(_) {
		return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default$5(+_), ribbon) : padAngle;
	};
...
function contours_default() {
	...
	contours.thresholds = function(_) {
		return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default$4(slice.call(_)) : constant_default$4(_), contours) : threshold;
	};
...
function density_default() {
	var x = defaultX$1, y = defaultY$1, weight = defaultWeight, dx = 960, dy = 500, r = 20, k = 2, o = r * 3, n = dx + o * 2 >> k, m = dy + o * 2 >> k, threshold = constant_default$4(20);
	function grid(data) {
	...
	density.x = function(_) {
		return arguments.length ? (x = typeof _ === "function" ? _ : constant_default$4(+_), density) : x;
	};
	density.y = function(_) {
		return arguments.length ? (y = typeof _ === "function" ? _ : constant_default$4(+_), density) : y;
	};
	density.weight = function(_) {
		return arguments.length ? (weight = typeof _ === "function" ? _ : constant_default$4(+_), density) : weight;
	};
	...
	density.thresholds = function(_) {
		return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default$4(slice.call(_)) : constant_default$4(_), density) : threshold;
	};
...
var epsilon$2 = 11102230246251565e-32;
var splitter = 134217729;
var resulterrbound = 3.000000000000001 * epsilon$2;
...
var ccwerrboundA = (3 + 16 * epsilon$2) * epsilon$2;
var ccwerrboundB = (2 + 12 * epsilon$2) * epsilon$2;
var ccwerrboundC = (9 + 64 * epsilon$2) * epsilon$2 * epsilon$2;
var B = vec(4);
var C1 = vec(8);
var C2 = vec(12);
var D = vec(16);
...
function orient2dadapt(ax, ay, bx, by, cx, cy, detsum) {
	...
	u$2[2] = _j - (u3 - bvirt) + (_i - bvirt);
	u$2[3] = u3;
	return D[sum$2(C2len, C2, 4, u$2, D) - 1];
}
...
(7 + 56 * epsilon$2) * epsilon$2;
(3 + 28 * epsilon$2) * epsilon$2;
(26 + 288 * epsilon$2) * epsilon$2 * epsilon$2;
vec(4);
vec(4);
vec(4);
vec(4);
...
vec(192);
vec(192);
(10 + 96 * epsilon$2) * epsilon$2;
(4 + 48 * epsilon$2) * epsilon$2;
(44 + 576 * epsilon$2) * epsilon$2 * epsilon$2;
vec(4);
vec(4);
vec(4);
vec(4);
...
vec(1152);
vec(1152);
(16 + 224 * epsilon$2) * epsilon$2;
(5 + 72 * epsilon$2) * epsilon$2;
(71 + 1408 * epsilon$2) * epsilon$2 * epsilon$2;
vec(4);
vec(4);
vec(4);
vec(4);
...
function collide_default(radius) {
	...
	if (typeof radius !== "function") radius = constant_default$3(radius == null ? 1 : +radius);
	function force() {
	...
	force.radius = function(_) {
		return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default$3(+_), initialize(), force) : radius;
	};
	return force;
}
//#endregion
...
function link_default(links) {
	var id = index$1, strength = defaultStrength, strengths, distance = constant_default$3(30), distances, nodes, count, bias, random, iterations = 1;
	if (links == null) links = [];
	...
	force.strength = function(_) {
		return arguments.length ? (strength = typeof _ === "function" ? _ : constant_default$3(+_), initializeStrength(), force) : strength;
	};
	force.distance = function(_) {
		return arguments.length ? (distance = typeof _ === "function" ? _ : constant_default$3(+_), initializeDistance(), force) : distance;
	};
	return force;
}
//#endregion
...
function manyBody_default() {
	var nodes, node, random, alpha, strength = constant_default$3(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = .81;
	function force(_) {
	...
	force.strength = function(_) {
		return arguments.length ? (strength = typeof _ === "function" ? _ : constant_default$3(+_), initialize(), force) : strength;
	};
...
function radial_default(radius, x, y) {
	var nodes, strength = constant_default$3(.1), strengths, radiuses;
	if (typeof radius !== "function") radius = constant_default$3(+radius);
	if (x == null) x = 0;
	if (y == null) y = 0;
	function force(alpha) {
...
function x_default(x) {
	var strength = constant_default$3(.1), nodes, strengths, xz;
	if (typeof x !== "function") x = constant_default$3(x == null ? 0 : +x);
	function force(alpha) {
	...
	force.x = function(_) {
		return arguments.length ? (x = typeof _ === "function" ? _ : constant_default$3(+_), initialize(), force) : x;
	};
	return force;
}
//#endregion
...
function y_default(y) {
	var strength = constant_default$3(.1), nodes, strengths, yz;
	if (typeof y !== "function") y = constant_default$3(y == null ? 0 : +y);
	function force(alpha) {
	...
	force.y = function(_) {
		return arguments.length ? (y = typeof _ === "function" ? _ : constant_default$3(+_), initialize(), force) : y;
	};
	return force;
}
//#endregion
...
function area_default$1(object) {
	areaSum$1 = new Adder();
...
function centroidLinePoint(lambda, phi) {
	lambda *= radians, phi *= radians;
	var cosPhi = cos(phi), x = cosPhi * cos(lambda), y = cosPhi * sin(lambda), z = sin(phi), w = atan2(sqrt$1((w = y0$4 * z - z0 * y) * w + (w = z0 * x - x0$4 * z) * w + (w = x0$4 * y - y0$4 * x) * w), x0$4 * x + y0$4 * y + z0 * z);
	W1 += w;
	X1$1 += w * (x0$4 + (x0$4 = x));
	Y1$1 += w * (y0$4 + (y0$4 = y));
	Z1$1 += w * (z0 + (z0 = z));
...
function circle_default() {
	var center = constant_default$2([0, 0]), radius = constant_default$2(90), precision = constant_default$2(2), ring, rotate, stream = { point };
	function point(x, y) {
	...
	circle.center = function(_) {
		return arguments.length ? (center = typeof _ === "function" ? _ : constant_default$2([+_[0], +_[1]]), circle) : center;
	};
	circle.radius = function(_) {
		return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default$2(+_), circle) : radius;
	};
	circle.precision = function(_) {
		return arguments.length ? (precision = typeof _ === "function" ? _ : constant_default$2(+_), circle) : precision;
	};
	return circle;
}
//#endregion
...
function line_default$1(a, b, x0, y0, x1, y1) {
	...
	return function(stream) {
		...
		function linePoint(x, y) {
			...
			if (first) {
				...
				if (line_default$1(a, b, x0, y0, x1, y1)) {
					if (!v_) {
						activeStream.lineStart();
...
function interpolate_default(a, b) {
	var x0 = a[0] * radians, y0 = a[1] * radians, x1 = b[0] * radians, y1 = b[1] * radians, cy0 = cos(y0), sy0 = sin(y0), cy1 = cos(y1), sy1 = sin(y1), kx0 = cy0 * cos(x0), ky0 = cy0 * sin(x0), kx1 = cy1 * cos(x1), ky1 = cy1 * sin(x1), d = 2 * asin(sqrt$1(haversin(y1 - y0) + cy0 * cy1 * haversin(x1 - x0))), k = sin(d);
...
function path_default(projection, context) {
	...
	path.projection = function(_) {
		...
		projectionStream = _ == null ? (projection = null, identity_default$2) : (projection = _).stream;
		return path;
	};
...
function resample(project, delta2) {
	function resampleLineTo(x0, y0, lambda0, a0, b0, c0, x1, y1, lambda1, a1, b1, c1, depth, stream) {
		...
		if (d2 > 4 * delta2 && depth--) {
			var a = a0 + a1, b = b0 + b1, c = c0 + c1, m = sqrt$1(a * a + b * b + c * c), phi2 = asin(c /= m), lambda2 = abs(abs(c) - 1) < 1e-6 || abs(lambda0 - lambda1) < 1e-6 ? (lambda0 + lambda1) / 2 : atan2(b, a), p = project(lambda2, phi2), x2 = p[0], y2 = p[1], dx2 = x2 - x0, dy2 = y2 - y0, dz = dy * dx2 - dx * dy2;
...
function projectionMutator(projectAt) {
	var project, k = 150, x = 480, y = 250, lambda = 0, phi = 0, deltaLambda = 0, deltaPhi = 0, deltaGamma = 0, rotate, alpha = 0, sx = 1, sy = 1, theta = null, preclip = antimeridian_default, x0 = null, y0, x1, y1, postclip = identity_default$2, delta2 = .5, projectResample, projectTransform, projectRotateTransform, cache, cacheStream;
	...
	projection.clipExtent = function(_) {
		return arguments.length ? (postclip = _ == null ? (x0 = y0 = x1 = y1 = null, identity_default$2) : clipRectangle(x0 = +_[0][0], y0 = +_[0][1], x1 = +_[1][0], y1 = +_[1][1]), reset()) : x0 == null ? null : [[x0, y0], [x1, y1]];
	};
	...
	projection.precision = function(_) {
		return arguments.length ? (projectResample = resample_default(projectTransform, delta2 = _ * _), reset()) : sqrt$1(delta2);
	};
...
function azimuthalInvert(angle) {
	return function(x, y) {
		var z = sqrt$1(x * x + y * y), c = angle(z), sc = sin(c), cc = cos(c);
...
function conicConformalRaw(y0, y1) {
	var cy0 = cos(y0), n = y0 === y1 ? sin(y0) : log$1(cy0 / cos(y1)) / log$1(tany(y1) / tany(y0)), f = cy0 * pow$1(tany(y0), n) / n;
...
naturalEarth1Raw.invert = function(x, y) {
	...
	do {
		var phi2 = phi * phi, phi4 = phi2 * phi2;
		phi -= delta = (phi * (1.007226 + phi2 * (.015085 + phi4 * (-.044475 + .028874 * phi2 - .005916 * phi4))) - y) / (1.007226 + phi2 * (.045255 + phi4 * (-.311325 + .259866 * phi2 - .005916 * 11 * phi4)));
...
function arc_default() {
	var innerRadius = arcInnerRadius, outerRadius = arcOuterRadius, cornerRadius = constant_default$9(0), padRadius = null, startAngle = arcStartAngle, endAngle = arcEndAngle, padAngle = arcPadAngle, context = null, path = withPath(arc);
	function arc() {
		...
		if (!(r1 > 1e-12)) context.moveTo(0, 0);
			...
			var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > 1e-12 && (padRadius ? +padRadius.apply(this, arguments) : sqrt$2(r0 * r0 + r1 * r1)), rc = min$2(abs$3(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t0, t1;
			if (rp > 1e-12) {
			...
			if (rc > 1e-12) {
				var x11 = r1 * cos$2(a11), y11 = r1 * sin$2(a11), x00 = r0 * cos$2(a00), y00 = r0 * sin$2(a00), oc;
				if (da < pi$3) {
	...
	arc.innerRadius = function(_) {
		return arguments.length ? (innerRadius = typeof _ === "function" ? _ : constant_default$9(+_), arc) : innerRadius;
	};
	arc.outerRadius = function(_) {
		return arguments.length ? (outerRadius = typeof _ === "function" ? _ : constant_default$9(+_), arc) : outerRadius;
	};
	arc.cornerRadius = function(_) {
		return arguments.length ? (cornerRadius = typeof _ === "function" ? _ : constant_default$9(+_), arc) : cornerRadius;
	};
	arc.padRadius = function(_) {
		return arguments.length ? (padRadius = _ == null ? null : typeof _ === "function" ? _ : constant_default$9(+_), arc) : padRadius;
	};
	arc.startAngle = function(_) {
		return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default$9(+_), arc) : startAngle;
	};
	arc.endAngle = function(_) {
		return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default$9(+_), arc) : endAngle;
	};
	arc.padAngle = function(_) {
		return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default$9(+_), arc) : padAngle;
	};
...
function pie_default() {
	var value = identity_default$1, sortValues = descending_default$1, sort = null, startAngle = constant_default$9(0), endAngle = constant_default$9(tau$4), padAngle = constant_default$9(0);
	function pie(data) {
		var i, n = (data = array_default$2(data)).length, j, k, sum = 0, index = new Array(n), arcs = new Array(n), a0 = +startAngle.apply(this, arguments), da = Math.min(tau$4, Math.max(-tau$4, endAngle.apply(this, arguments) - a0)), a1, p = Math.min(Math.abs(da) / n, padAngle.apply(this, arguments)), pa = p * (da < 0 ? -1 : 1), v;
	...
	pie.value = function(_) {
		return arguments.length ? (value = typeof _ === "function" ? _ : constant_default$9(+_), pie) : value;
	};
	...
	pie.startAngle = function(_) {
		return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default$9(+_), pie) : startAngle;
	};
	pie.endAngle = function(_) {
		return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default$9(+_), pie) : endAngle;
	};
	pie.padAngle = function(_) {
		return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default$9(+_), pie) : padAngle;
	};
	return pie;
}
//#endregion
...
function link(curve) {
	...
	link.x = function(_) {
		return arguments.length ? (x = typeof _ === "function" ? _ : constant_default$9(+_), link) : x;
	};
	link.y = function(_) {
		return arguments.length ? (y = typeof _ === "function" ? _ : constant_default$9(+_), link) : y;
	};
